...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="obra">
        ###  http://www.semanticweb.org/joaopimentel/ontologies/2020/1/arquivo_musical#<xsl:value-of select="@id"/>
    ...
    <xsl:template match="instrumento" mode="second">
        ###  http://www.semanticweb.org/joaopimentel/ontologies/2020/1/arquivo_musical#<xsl:value-of select="translate(designacao, ' ','')"/>
    ...
    <xsl:template match="partitura" mode="second">
        ###  http://www.semanticweb.org/joaopimentel/ontologies/2020/1/arquivo_musical#<xsl:value-of select="@path"/>
    ...
    <xsl:template match="inf-relacionada" mode="second">
        ###  http://www.semanticweb.org/joaopimentel/ontologies/2020/1/arquivo_musical#<xsl:value-of select="video"/>
